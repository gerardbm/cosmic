...
H01 = BA  ; S01 = 55 ; L01 = 92 ; BASE1 = [] ; ZASE1 = [] #base1
H02 = BA  ; S02 = 55 ; L02 = 89 ; BASE2 = [] ; ZASE2 = [] #base2
...
# Output the values
with open('../xresources/Xresources.solar_c9', 'w') as f:
    sys.stdout = f
    print("! Cosmic Solar C9")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Solar C9")
    print(f"URxvt.keysym.C-9: command:\\033]10;{HEX03}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/cosmic-solar-c9.md', 'w') as f:
    sys.stdout = f
    print("# Cosmic Solar C9")
    print("")
    print("```")
