...
H01 = BA  ; S01 = 55 ; L01 = 94 ; BASE1 = [] ; ZASE1 = [] #base1
H02 = BA  ; S02 = 55 ; L02 = 91 ; BASE2 = [] ; ZASE2 = [] #base2
...
# Output the values
with open('../xresources/Xresources.solar_c8', 'w') as f:
    sys.stdout = f
    print("! Cosmic Solar C8")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
...
# Output the values
with open('../values/cosmic-solar-c8.md', 'w') as f:
    sys.stdout = f
    print("# Cosmic Solar C8")
    print("")
    print("```")
