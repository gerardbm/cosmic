...
H01 = BA  ; S01 = 55 ; L01 = 96 ; BASE1 = [] ; ZASE1 = [] #base1
H02 = BA  ; S02 = 55 ; L02 = 93 ; BASE2 = [] ; ZASE2 = [] #base2
H03 = BA  ; S03 = 10 ; L03 = 25 ; BASE3 = [] ; ZASE3 = [] #base4
H04 = BA  ; S04 = 20 ; L04 = Lb ; BASE4 = [] ; ZASE4 = [] #base3
...
# Output the values
with open('../xresources/Xresources.solar_c7', 'w') as f:
    sys.stdout = f
    print("! Cosmic Solar C7")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Solar C7")
    print(f"URxvt.keysym.C-7: command:\\033]10;{HEX03}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/cosmic-solar-c7.md', 'w') as f:
    sys.stdout = f
    print("# Cosmic Solar C7")
    print("")
    print("```")
