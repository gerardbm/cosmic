...
H01 = BA  ; S01 = 95 ; L01 = 6  ; BASE1 = [] ; ZASE1 = [] #base1
H02 = BA  ; S02 = 95 ; L02 = 9  ; BASE2 = [] ; ZASE2 = [] #base2
H03 = BA  ; S03 = 20 ; L03 = 55 ; BASE3 = [] ; ZASE3 = [] #base3
H04 = BA  ; S04 = 10 ; L04 = Lb ; BASE4 = [] ; ZASE4 = [] #base4
...
# Output scheme
with open('../xresources/Xresources.scheme', 'w') as f:
    sys.stdout = f
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
...
# Output the values
with open('../xresources/Xresources.lunar_c3', 'w') as f:
    sys.stdout = f
    print("! Cosmic Lunar C3")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
    print("#define base4", HEX04)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Lunar C3")
    print(f"URxvt.keysym.C-3: command:\\033]10;{HEX04}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/cosmic-lunar-c3.md', 'w') as f:
    sys.stdout = f
    print("# Cosmic Lunar C3")
    print("")
    print("```")
