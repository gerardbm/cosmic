...
H01 = BA  ; S01 = 95 ; L01 = 2  ; BASE1 = [] ; ZASE1 = [] #base1
H02 = BA  ; S02 = 95 ; L02 = 5  ; BASE2 = [] ; ZASE2 = [] #base2
...
# Output the values
with open('../xresources/Xresources.lunar_c1', 'w') as f:
    sys.stdout = f
    print("! Cosmic Lunar C1")
    print("#define base1", HEX01)
    print("#define base2", HEX02)
    print("#define base3", HEX03)
    print("#define base4", HEX04)
...
with open('../xresources/Xresources.URxvtSwitch', 'a+') as f:
    ...
    print("")
    print("! Lunar C1")
    print(f"URxvt.keysym.C-1: command:\\033]10;{HEX04}\\007\\033]11;{HEX01}\\007\\")
...
# Output the values
with open('../values/cosmic-lunar-c1.md', 'w') as f:
    sys.stdout = f
    print("# Cosmic Lunar C1")
    print("")
    print("```")
